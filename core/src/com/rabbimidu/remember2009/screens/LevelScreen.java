...
import com.rabbimidu.remember2009.scene2d.PagedScrollPane;
...
public class LevelScreen extends Screens {
    ...
    public LevelScreen(MainLander game) {
        ...
        table.add(scroll).expand().fill().pad(32).top();
    ...
    public Button getLevelButton(final int level) {
        ...
        button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                if (!button.isDisabled()) game.setScreen(new GameScreen(game, level));
            }
        });
        return button;
    }
